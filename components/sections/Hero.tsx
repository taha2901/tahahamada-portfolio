...
//         <motion.div
//           {...fadeUp(0.34)}
//           className="mb-5 flex w-full flex-col gap-3 sm:flex-row sm:justify-center"
//         >
//           <a
...
//           dir=rtl flips it automatically for Arabic
//           h-full stays in viewport — no scroll
//       ════════════════════════════════════════════════════════════ */}
//       <div
//         className="
...
export default function Hero() {
  ...
  return (
    ...
    <section
      id="home"
      dir={isAr ? "rtl" : "ltr"}
      className="relative bg-slate-950 min-h-screen lg:h-screen overflow-hidden w-full"
    >
      {/* ── noise ── */}
      <div
        className="pointer-events-none absolute inset-0 opacity-[0.03]"
