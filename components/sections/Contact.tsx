          ...
          >
            {contactItems.map((item) => (
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
className="
group flex min-w-0 items-center gap-4 rounded-2xl p-4 sm:p-5
...
<p className="truncate text-sm font-medium text-slate-800 dark:text-white group-hover:text-brand-500">                    {item.value}
                  </p>
                </div>
